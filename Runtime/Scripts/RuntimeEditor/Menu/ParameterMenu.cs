...
namespace Dash
{
    public class ParameterMenu
    {
        ...
        public static void Show(Parameter p_parameter)
        {
            ...
            {
                menu.AddItem(new GUIContent("Direct Value"), false, () => p_parameter.isExpression = false);   
            }
            else
            {
                menu.AddItem(new GUIContent("Custom Expression"), false, () => p_parameter.isExpression = true);
            }
